...
#include <_stdio.h>
#include "../../../../../../../../../Library/Developer/CommandLineTools/SDKs/MacOSX15.2.sdk/usr/include/_stdio.h"
                    ...
                    if (isNonTerminal(stackTop)) {
                        ...
                        if (index != -1) {
                            for (int i = 0; i < firstSets[index].count; i++) {
                                ...
                                if (strcmp(terminal, "ε") != 0) { // Ignore epsilon in error messages
                                    if (firstFound) strcat(firstSetStr, ", ");
                                    strcat(firstSetStr, terminal);
                                    firstFound = true;
                                }
                            }
                        }
